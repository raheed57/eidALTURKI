...
const dict = {
  ar: {
    // اسم الموقع الجديد
    brandTitle: "عيد ذريه عفاف و منصور",
    brandSub: "",
    lang: "EN",
    theme: "ليلي/نهاري",
    logout: "تسجيل خروج",
...
احبكمم 🤍🤍🤍🤍🤍🤍🤍🤍🤍🤍`,
    ...
    introText: "اقرأ الشرح، ثم فعّل (فهمت) في الجزئين او اكتب سؤالك حتى يظهر زر التالي.",
...
نتمنى الفوز للقارئ😘`,
    ...
    stoppedAt: "توقفت عند:",
    spinTryAgain: "صار خطأ، حاول مرة ثانية.",
